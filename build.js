...
function tokenColors(p, italic) {
  ...
  return [
    ...
    },
    {
      ...
      scope: ["entity.name.tag", "entity.name.tag.html", "entity.name.tag.template", "entity.name.tag.script", "entity.name.tag.style"],
      settings: style(p.lavender, false),
    },
    {
      name: "Tag angle-bracket punctuation",
      scope: [
      ...
      settings: style(p.tagPunct, false),
    },
    {
      name: "Component tags (JSX/Vue PascalCase)",
      scope: ["support.class.component", "entity.name.tag.namespace", "meta.tag.custom"],
      settings: style(p.blue, false),
    },
    {
      name: "Tag attribute names",
      scope: ["entity.other.attribute-name", "entity.other.attribute-name.html"],
      settings: style(p.amber, true),
    },
    {
      name: "HTML/Vue attribute values",
      scope: ["meta.attribute string.quoted", "string.quoted.double.html", "string.quoted.single.html"],
      settings: style(p.green, false),
    },
    {
      name: "Vue directives (v-if / @click / :prop / #slot)",
      scope: [
        "entity.other.attribute-name.vue.directive",
        "meta.directive.vue",
